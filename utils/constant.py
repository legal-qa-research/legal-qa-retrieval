...
pkl_bm25_infer_result = os.path.join(pkl_root, 'alqac_2022_infer_bm25.pkl')
pkl_sent_bert_v4_infer_result = os.path.join(pkl_root, 'alqac_2022_infer_test_sent_bert_v4_full_v1.pkl')
pkl_sent_bert_v7_infer_result = os.path.join(pkl_root, 'alqac_2022_infer_test_sent_bert_v7_full_v1.pkl')
pkl_xgboost_infer_result = os.path.join(pkl_root, 'alqac_2022_infer_xgboost_v1.pkl')
