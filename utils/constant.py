...
pkl_private_question_pool = os.path.join(pkl_root, 'kse_private_test_question_pool.pkl')
pkl_bm25okapi = os.path.join(pkl_root, 'kse_bm25okapi_v1.pkl')
pkl_cached_rel = os.path.join(pkl_root, 'kse_cached_rel_v2_top50.pkl')
pkl_private_cached_rel = os.path.join(pkl_root, 'kse_private_cached_rel_v1_top50.pkl')
pkl_split_ids = os.path.join(pkl_root, 'kse_split_ids.pkl')
pkl_tfidf = os.path.join('pkl_file', 'kse_tfidf.pkl')
