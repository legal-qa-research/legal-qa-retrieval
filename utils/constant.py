...
pkl_sent_bert_v4_infer_result = os.path.join(pkl_root, 'alqac_2022_infer_test_sent_bert_v4_full.pkl')
pkl_sent_bert_v7_infer_result = os.path.join(pkl_root, 'alqac_2022_infer_test_sent_bert_v7_full.pkl')
