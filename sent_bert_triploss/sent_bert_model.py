...
def get_sent_bert_model(load_chk_point_path) -> SentenceTransformer:
    if load_chk_point_path is not None:
        ...
        return SentenceTransformer(model_name_or_path=load_chk_point_path, device='cpu')
    else:
        ...
        return SentenceTransformer(modules=[bert_embedding_model, pooling_model], device='cpu')
